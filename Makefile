...
# Dependencies
# NOTE: Although dependencies are defined in submakes, we pre-build them to
# prevent issues during parallel builds.
ocean_only: fms2
ice_ocean_SIS2: fms2 atmos_null land_null icebergs ice_param
coupled_AM2_LM3_SIS2: fms1 AM2 LM3 icebergs_fms1 ice_param_fms1
atmos_null land_null icebergs ice_param: fms2
AM2 LM3 icebergs_fms1 ice_param_fms1: fms1
